...
const RU = {
    ...
    SETTING_SHAKE: 'Встряхивание устройства',
    SHAKE_DISABLED: 'Встряхивание отключено',
    SHAKE_ENABLED: 'Встряхивание включено',
    ...
    BT_IS_DISABLED: 'Bluetooth отключен',
    PLS_ENABLE_BT: 'Для работы приложения необходимо включить bluetooth',
...
const EN = {
    ...
    SETTING_SHAKE: 'Toggle device shaking',
    SHAKE_DISABLED: 'Shaking disabled',
    SHAKE_ENABLED: 'Shake enabled',
    ...
    BT_IS_DISABLED: 'Bluetooth is disabled',
    PLS_ENABLE_BT: 'Enable bluetooth to continue using application',
